const raw=import.meta.env.PROD
  ? import.meta.env.VITE_API_BASE_URL
  : import.meta.env.VITE_API_BASE_URL||import.meta.env.VITE_API_URL||"http://127.0.0.1:8080";
if(!raw)throw new Error("Production build için VITE_API_BASE_URL zorunludur.");
